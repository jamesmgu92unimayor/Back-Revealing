...
public class KitchenTypeController {
    ...
    @PostMapping()
    public ResponseEntity<GeneralBodyResponse<KitchenTypeDto>> save(@Valid @RequestBody KitchenTypeDto dto, Locale locale) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<GeneralBodyResponse<KitchenTypeDto>> update(@PathVariable("id") UUID id, @Valid @RequestBody KitchenTypeDto dto, Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @GetMapping("{id}")
    public ResponseEntity<GeneralBodyResponse<KitchenTypeDto>> getById(@PathVariable("id") UUID id, Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @GetMapping("page")
    public ResponseEntity<GeneralBodyResponse<Page<KitchenTypeDto>>> getPage(Pageable pageable, Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @GetMapping("all")
    public ResponseEntity<GeneralBodyResponse<List<KitchenTypeDto>>> getAll(Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(new GeneralBodyResponse<>(messageSource.getMessage(GENERAL_LIST_SUCCESS, null, locale),
