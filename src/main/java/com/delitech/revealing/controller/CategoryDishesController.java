...
public class CategoryDishesController {
    ...
    private final CategoryDishesService service;
    private final MessageSource messageSource;

    @PostMapping()
    public ResponseEntity<GeneralBodyResponse<CategoryDishesDto>> save(@Valid @RequestBody CategoryDishesDto dto, Locale locale) {
    ...
    @PutMapping("{id}")
    public ResponseEntity<GeneralBodyResponse<CategoryDishesDto>> update(@PathVariable("id") UUID id, @Valid @RequestBody CategoryDishesDto dto, Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @GetMapping("{id}")
    public ResponseEntity<GeneralBodyResponse<CategoryDishesDto>> getById(@PathVariable("id") UUID id, Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @GetMapping("page")
    public ResponseEntity<GeneralBodyResponse<Page<CategoryDishesDto>>> getPage(Pageable pageable, Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @GetMapping("all")
    public ResponseEntity<GeneralBodyResponse<List<CategoryDishesDto>>> getAll(Locale locale) {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(new GeneralBodyResponse<>(messageSource.getMessage(GENERAL_LIST_SUCCESS, null, locale),
